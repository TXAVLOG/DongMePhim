...
export const seedSettings: SiteSettings = {
  ...
  app: {
    app_version: "5.1.1",
    app_release_notes: "- 🛠️ [FIX] Khắc phục hoàn toàn lỗi crash do không nạp được icon thông báo (Invalid small icon) khi tải bản cập nhật trên thiết bị Android\n- 📡 [STATS] Tích hợp bộ đếm phim yêu thích và các thông số hoạt động chi tiết lên trang cá nhân & Bot Discord",
    app_changelogs: [
      {
        version: "5.1.1",
        date: "2026-07-19",
    ...
    app_ios_ipa_url: "https://github.com/TXAVLOG/dongmephim-mobile/releases/download/v5.1.1_511/DongMePhim-Premium-v5.1.1+511.ipa",
    ...
    app_windows_download_url: "https://pub-ffb3837c19c940af8cc1bc7f2682fd70.r2.dev/DongMePhim_v5.1.1_Setup.exe",
